        ...
        <div class="sub-mv-inner">
            ...
            <div class="sub-mv-content">
                <picture>
                    ...
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/photo-contact.jpg" alt="高層ビルへつながる階段をサラリーマンが上っています" class="sub-mv__img" width="1920" height="640">
                </picture>
