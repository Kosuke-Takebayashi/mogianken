...
<main class="main">
    ...
    <div class="sub-mv">
        <div class="sub-mv-inner">
            <div class="sub-mv-text">
                <h2 class="sub-mv-main-text">Service</h2>
                <p class="sub-mv-sub-text">事業内容</p>
            </div>
            <div class="sub-mv-content">
                <picture>
                    <source media="(max-width: 767px)" srcset="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/photo-service-mv-sp.jpg">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/photo-service-mv.jpg" alt="握手をしている男性2人の手" class="sub-mv__img" width="1920" height="640">
                </picture>
    ...
    <div class="main-content-inner">
        ...
        <section class="advantage section">
            ...
            <div class="section-content advantage__section-content">
        ...
        <section class="featre section">
            ...
            <div class="section-content feature__section-content">
                <div class="section-content-inner">
